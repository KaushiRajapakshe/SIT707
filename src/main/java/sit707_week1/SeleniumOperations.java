...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		System.setProperty("webdriver.chrome.driver", "/Users/kaushirajapakshe/Downloads/chromedriver-mac-x64/chromedriver");
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from s223681886, Isuri Kaushalya Rajapaksha Dona");
